...
public class WritableConfigYamlProviderTests
{
    ...
    [Fact]
    public async Task DeleteKey_SimpleProperty_ShouldRemoveFromYamlFile()
    {
        var testFileName = Path.GetRandomFileName();
        ...
        fileContent.ShouldContain("yaml_test");
        fileContent.ShouldContain("value:");
        fileContent.ShouldContain("100");
        fileContent.ShouldContain("nested:");
    }

    [Fact]
    public async Task DeleteKey_NestedProperty_ShouldRemoveFromYamlFile()
    {
        var testFileName = Path.GetRandomFileName();
        ...
        fileContent.ShouldContain("nested:");
        fileContent.ShouldContain("price:");
        fileContent.ShouldContain("19.99");
    ...
    public async Task DeleteKey_CombinedWithUpdate_ShouldWork()
    {
        ...
        fileContent.ShouldContain("999");
        fileContent.ShouldContain("updated1");
        fileContent.ShouldContain("updated2");
