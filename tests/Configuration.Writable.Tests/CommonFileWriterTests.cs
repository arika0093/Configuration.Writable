...
public class CommonFileWriterTests
{
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test1/test_{Guid.NewGuid()}.txt");
    ...
    {
        var testDir = Path.Combine(Path.GetTempPath(), $"test2/testdir_{Guid.NewGuid()}");
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test3/test_{Guid.NewGuid()}.txt");
        var writer = new CommonFileWriter();
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test4/test_{Guid.NewGuid()}.txt");
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test5/test_{Guid.NewGuid()}.txt");
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test6/test_{Guid.NewGuid()}.txt");
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test7/test_{Guid.NewGuid()}.txt");
        var writer = new CommonFileWriter();
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test8/test_{Guid.NewGuid()}.txt");
        var writer = new CommonFileWriter();
        var content = Encoding.UTF8.GetBytes("Test content");
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test9/test_{Guid.NewGuid()}.txt");
        var writer = new CommonFileWriter();
    ...
    {
        var testFile = Path.Combine(Path.GetTempPath(), $"test10/test_{Guid.NewGuid()}.txt");
        var writer = new CommonFileWriter();
