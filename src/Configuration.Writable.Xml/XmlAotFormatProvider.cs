...
/// <remarks>
/// <para>
/// Initializes a new instance of the <see cref="XmlAotFormatProvider"/> class
/// with the specified serializer factory.
/// </para>
/// </remarks>
...
{
    private readonly Func<Type, XmlSerializer> _serializerFactory =
        ...
        where T : class, new()
    {
        ...
        var serializer = _serializerFactory(typeof(T));
