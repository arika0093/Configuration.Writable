...
/// </summary>
/// <remarks>
/// Use this provider when you need to support Native AOT deployment or when you want to avoid
/// reflection-based serialization. Pass a JsonSerializerContext that includes all types
/// you need to serialize/deserialize.
/// </remarks>
/// <example>
/// <code>
/// // Define your JsonSerializerContext
/// [JsonSerializable(typeof(MySettings))]
/// public partial class MySettingsContext : JsonSerializerContext;
///
/// // Use the provider
/// builder.Services.AddWritableOptions&lt;MySettings&gt;(conf =&gt;
/// {
///     conf.FormatProvider = new JsonAotFormatProvider(MySettingsContext.Default);
/// });
/// </code>
/// </example>
public class JsonAotFormatProvider : FormatProviderBase
{
    ...
    public JsonAotFormatProvider(IJsonTypeInfoResolver typeInfoResolver)
    {
