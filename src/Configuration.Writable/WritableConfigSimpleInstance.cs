...
public class WritableConfigSimpleInstance
{
    ...
    public void Initialize<T>(Action<WritableConfigurationOptionsBuilder<T>> configurationOptions)
        where T : class
    {
        Reset();
    ...
    public void Initialize<T>(WritableConfigurationOptionsBuilder<T> configurationBuilder)
        where T : class
    {
        Reset();
        // add default configuration sources
